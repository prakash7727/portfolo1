...
document.addEventListener("DOMContentLoaded", function() {
  (function(){    
    ...
    var scroll_func = function(){
      setTimeout(scroll_enb, 1000); 
    };

    var scroll_enb = function(){
      html.style.overflowY = "scroll";
    };

    var display_func = function(){
      setTimeout(display_enb, 1000); 
    };

    var display_enb = function(){
...
// Function to scroll to a specific section based on the link clicked

function scrollToSection(link) {
  // Get the name of the section to scroll to
  const sectionName = link.getAttribute('name');
  
  // Find the target section using the name
